...
export const ConversationEmptyState = ({
	className,
	// Persian defaults: the skill's rule is that every user-visible string is Persian,
	// including the ones a consumer forgets to override.
	title = "هنوز پیامی نیست",
	description = "برای شروع گفتگو، پیامی بنویسید",
	icon,
	children,
	...props
