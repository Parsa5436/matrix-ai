...
// Base UI's Menu.Item fires `onClick`; it has no Radix-style `onSelect`.
...
export const PromptInputSubmit = ({
	...
	return (
		<InputGroupButton
			aria-label={isGenerating ? "توقف پاسخ" : "ارسال سؤال"}
			className={cn(className)}
			onClick={handleClick}
			size={size}
...
// Base UI moved the hover delays onto PreviewCard.Trigger, so there is nothing left
// for this wrapper to forward.
