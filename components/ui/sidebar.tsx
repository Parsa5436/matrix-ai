...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// Remembers the sidebar across visits. Cookie Store API is not in Safari, and a
			// silent no-op is fine for a UI preference — nothing here is security-relevant.
			...
			<Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
				...
				>
					<SheetHeader className="sr-only">
						...
						<SheetDescription>فهرست گفتگوهای شما.</SheetDescription>
					</SheetHeader>
...
function SidebarTrigger({
	...
	return (
		...
		>
			...
			<span className="sr-only">نمایش یا بستن فهرست گفتگوها</span>
		</Button>
	);
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
	...
	return (
		<button
			...
			title="نمایش یا بستن فهرست گفتگوها"
			className={cn(
